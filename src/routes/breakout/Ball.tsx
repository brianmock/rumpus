type DrawBall = { ctx: CanvasRenderingContext2D, x: number, y: number, augmentations: string[], ballRadius: number}

export function drawBall({ augmentations = [], ctx, x, y, ballRadius }: DrawBall) {
